...
THERMAL_CONDUCTIVITY_DATA_INSERT_QUERY = config.THERMAL_CONDUCTIVITY_DATA_INSERT_QUERY
THERMAL_CONDUCTIVITY_XY_DATA_INSERT_QUERY = config.THERMAL_CONDUCTIVITY_XY_DATA_INSERT_QUERY
