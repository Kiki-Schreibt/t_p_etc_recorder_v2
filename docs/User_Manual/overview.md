...
- Manually identifying and counting hundreds of hydrogenation/dehydrogenation cycles from temperature and pressure curves  
- Estimating cycle counts based on predefined temperature programs or manual adjustments when automated recording is unavailable  
- Calculating hydrogen uptake and release across many cycles using pressure differentials  
- Correlating ETC measurements with corresponding temperature, pressure, and cycle data to analyze dependencies  

Even this basic level of analysis can require substantial time and effort, often limiting the overall efficiency of long-term testing.

This software is designed to address these challenges directly. Its core functionalities include:

- Automated detection and counting of hydrogenation/dehydrogenation cycles  
- Calculation of absorbed and released hydrogen quantities  
- Integration of temperature, pressure, and ETC data into a unified dataset  
