...
def get_ui_file_path(folder_name, ui_file_name):
    base_dir = get_base_dir()
    config_dir = os.path.join(base_dir, "src", "recorder_app", "gui", folder_name, "ui")
...
standard_periodic_table_txt = get_config_path('gui/data_fitter/Periodic_Table_of_Elements.txt')
